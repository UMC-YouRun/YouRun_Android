...
import com.example.yourun.databinding.FragmentAppExp4Binding

class AppExpFragment4: Fragment() {

    private var _binding: FragmentAppExp4Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAppExp4Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // "더 많이, 더 꾸준히" 텍스트 색상 변경
        val fullText = binding.txtAppExpWhoRun.text.toString()
        ...
        binding.txtAppExpWhoRun.text = spannableString
    }
