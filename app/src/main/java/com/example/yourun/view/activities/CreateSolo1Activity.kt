...
import com.example.yourun.databinding.ActivityCreateSolo1Binding
import java.time.LocalDate

class CreateSolo1Activity : AppCompatActivity() {

    private lateinit var binding: ActivityCreateSolo1Binding
